...
| ----------- | ----------- |----------- |
| Проект 1 Анализ продуктовых метрик   | Оценка месячного retention с помощью когортного анализа, |Ячейка 2   |
                                       |  опрделениее PMF, расчет и анализ продуктовых метрик,    |Ячейка 2   |
                                       |   проверка гипотез                                       |Ячейка 2   |
