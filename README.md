...
| ----------- | ----------- |----------- |
| Проект 1 Анализ продуктовых метрик   | Оценка месячного retention с помощью когортного анализа,
 опрделениее PMF, расчет и анализ продуктовых метрик, проверка гипотез   |Ячейка 2   |
